---
id: "debug-message-order"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-message-order.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-message-order.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `70 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-message-order.ts`
