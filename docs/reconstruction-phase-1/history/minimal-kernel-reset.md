---
id: "minimal-kernel-reset"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/minimal-kernel-reset.ts"
...
# 🤖 minimal-kernel-reset

**Ubicación:** `apps/api/src/scripts/minimal-kernel-reset.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/minimal-kernel-reset.ts`
