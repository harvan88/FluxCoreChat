---
id: "debug-outbox-for-message"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-for-message.ts"
...
# 🤖 debug-outbox-for-message

**Ubicación:** `apps/api/src/scripts/debug-outbox-for-message.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `111 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-outbox-for-message.ts`
