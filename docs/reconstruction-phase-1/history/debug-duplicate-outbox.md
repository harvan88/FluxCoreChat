---
id: "debug-duplicate-outbox"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-duplicate-outbox.ts"
...
# 🤖 debug-duplicate-outbox

**Ubicación:** `apps/api/src/scripts/debug-duplicate-outbox.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `106 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-duplicate-outbox.ts`
