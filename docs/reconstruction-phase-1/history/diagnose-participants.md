---
id: "diagnose-participants"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/db/diagnose-participants.ts"
...
**Ubicación:** `apps/api/src/db/diagnose-participants.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `62 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/db/diagnose-participants.ts`
