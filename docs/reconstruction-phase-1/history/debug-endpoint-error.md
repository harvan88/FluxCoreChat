---
id: "debug-endpoint-error"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-endpoint-error.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-endpoint-error.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `72 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-endpoint-error.ts`
