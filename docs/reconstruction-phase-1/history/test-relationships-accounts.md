---
id: "test-relationships-accounts"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/db/test-relationships-accounts.ts"
...
# 🤖 test-relationships-accounts

**Ubicación:** `apps/api/src/db/test-relationships-accounts.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `120 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/db/test-relationships-accounts.ts`
