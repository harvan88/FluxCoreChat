---
id: "clear-all-signals"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/clear-all-signals.ts"
...
**Ubicación:** `apps/api/src/scripts/clear-all-signals.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `56 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/clear-all-signals.ts`
