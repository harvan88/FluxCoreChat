---
id: "compile-kernel-files"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/compile-kernel-files.ts"
...
**Ubicación:** `apps/api/src/scripts/compile-kernel-files.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/compile-kernel-files.ts`
