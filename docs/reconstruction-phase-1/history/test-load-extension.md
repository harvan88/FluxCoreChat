---
id: "test-load-extension"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/_legacy_archive/test-load-extension.ts"
...
**Ubicación:** `apps/api/src/_legacy_archive/test-load-extension.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `31 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/_legacy_archive/test-load-extension.ts`
