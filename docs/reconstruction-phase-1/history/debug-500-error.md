...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-500-error.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-500-error.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `59 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-500-error.ts`
