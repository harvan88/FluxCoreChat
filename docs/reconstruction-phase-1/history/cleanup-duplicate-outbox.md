---
id: "cleanup-duplicate-outbox"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/cleanup-duplicate-outbox.ts"
...
# 🤖 cleanup-duplicate-outbox

**Ubicación:** `apps/api/src/scripts/cleanup-duplicate-outbox.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `91 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/cleanup-duplicate-outbox.ts`
