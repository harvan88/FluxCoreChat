---
id: "comprehensive-kernel-audit"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/comprehensive-kernel-audit.ts"
...
# 🤖 comprehensive-kernel-audit

**Ubicación:** `apps/api/src/scripts/comprehensive-kernel-audit.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `178 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/comprehensive-kernel-audit.ts`
