---
id: "debug-outbox-payload"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-payload.ts"
...
# 🤖 debug-outbox-payload

**Ubicación:** `apps/api/src/scripts/debug-outbox-payload.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `55 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-outbox-payload.ts`
