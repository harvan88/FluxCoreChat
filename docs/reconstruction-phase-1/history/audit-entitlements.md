---
id: "audit-entitlements"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/audit-entitlements.ts"
...
**Ubicación:** `apps/api/src/scripts/audit-entitlements.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/audit-entitlements.ts`
