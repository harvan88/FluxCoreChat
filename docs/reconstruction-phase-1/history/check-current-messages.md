---
id: "check-current-messages"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/check-current-messages.ts"
...
**Ubicación:** `apps/api/src/check-current-messages.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/check-current-messages.ts`
