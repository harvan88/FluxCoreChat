...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/find-web-simple.ts"
...
**Ubicación:** `apps/api/src/scripts/find-web-simple.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `121 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/find-web-simple.ts`
