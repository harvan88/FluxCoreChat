---
id: "debug-outbox-account-id"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-account-id.ts"
...
# 🤖 debug-outbox-account-id

**Ubicación:** `apps/api/src/scripts/debug-outbox-account-id.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/debug-outbox-account-id.ts`
