---
id: "verify-direct-persistence"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/verify-direct-persistence.ts"
...
# 🤖 verify-direct-persistence

**Ubicación:** `apps/api/src/scripts/verify-direct-persistence.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `125 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/verify-direct-persistence.ts`
