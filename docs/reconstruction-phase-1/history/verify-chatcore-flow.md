---
id: "verify-chatcore-flow"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/verify-chatcore-flow.ts"
...
# 🤖 verify-chatcore-flow

**Ubicación:** `apps/api/src/scripts/verify-chatcore-flow.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `154 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/verify-chatcore-flow.ts`
