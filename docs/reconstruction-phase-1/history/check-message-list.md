---
id: "check-message-list"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/check-message-list.ts"
...
**Ubicación:** `apps/api/src/check-message-list.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/check-message-list.ts`
