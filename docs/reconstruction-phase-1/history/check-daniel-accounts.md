---
id: "check-daniel-accounts"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/check-daniel-accounts.ts"
...
# 🤖 check-daniel-accounts

**Ubicación:** `apps/api/src/check-daniel-accounts.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `74 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/check-daniel-accounts.ts`
