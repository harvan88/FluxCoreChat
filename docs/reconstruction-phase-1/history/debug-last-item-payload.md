---
id: "debug-last-item-payload"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-last-item-payload.ts"
...
# 🤖 debug-last-item-payload

**Ubicación:** `apps/api/src/scripts/debug-last-item-payload.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `85 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-last-item-payload.ts`
