---
id: "audit-chatcore-reality"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/audit-chatcore-reality.ts"
...
# 🤖 audit-chatcore-reality

**Ubicación:** `apps/api/src/audit-chatcore-reality.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `304 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/audit-chatcore-reality.ts`
