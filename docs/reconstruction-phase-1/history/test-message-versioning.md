---
id: "test-message-versioning"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/db/test-message-versioning.ts"
...
**Ubicación:** `apps/api/src/db/test-message-versioning.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `175 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/db/test-message-versioning.ts`
...
- `../services/message-version.service`
