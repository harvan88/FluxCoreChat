---
id: "audit-chatcore-working"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/audit-chatcore-working.ts"
...
# 🤖 audit-chatcore-working

**Ubicación:** `apps/api/src/audit-chatcore-working.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `260 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/audit-chatcore-working.ts`
