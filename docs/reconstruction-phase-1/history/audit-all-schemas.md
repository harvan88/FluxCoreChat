---
id: "audit-all-schemas"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/audit-all-schemas.ts"
...
**Ubicación:** `apps/api/src/scripts/audit-all-schemas.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `81 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/audit-all-schemas.ts`
