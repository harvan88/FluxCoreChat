---
id: "debug-envelope-account-id"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-envelope-account-id.ts"
...
# 🤖 debug-envelope-account-id

**Ubicación:** `apps/api/src/scripts/debug-envelope-account-id.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/debug-envelope-account-id.ts`
