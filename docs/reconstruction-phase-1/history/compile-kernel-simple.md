---
id: "compile-kernel-simple"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/compile-kernel-simple.ts"
...
# 🤖 compile-kernel-simple

**Ubicación:** `apps/api/src/scripts/compile-kernel-simple.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/compile-kernel-simple.ts`
