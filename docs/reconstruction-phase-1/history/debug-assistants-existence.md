---
id: "debug-assistants-existence"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-assistants-existence.ts"
...
# 🤖 debug-assistants-existence

**Ubicación:** `apps/api/src/scripts/debug-assistants-existence.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `44 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-assistants-existence.ts`
