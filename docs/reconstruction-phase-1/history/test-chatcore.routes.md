---
id: "test-chatcore-routes"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/routes/test-chatcore.routes.ts"
...
# 🤖 test-chatcore.routes

**Ubicación:** `apps/api/src/routes/test-chatcore.routes.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `65 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/routes/test-chatcore.routes.ts`
