---
id: "force-outbox-process"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/force-outbox-process.ts"
...
# 🤖 force-outbox-process

**Ubicación:** `apps/api/src/scripts/force-outbox-process.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `90 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/force-outbox-process.ts`
...
- `@fluxcore/db`
- `../services/fluxcore/chatcore-gateway.service`
