...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/send-test-message.ts"
...
**Ubicación:** `apps/api/src/scripts/send-test-message.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `119 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/send-test-message.ts`
