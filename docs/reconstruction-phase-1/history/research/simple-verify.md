...
status: "wip"
criticality: "medium"
location: "apps/api/src/db/simple-verify.ts"
...
**Ubicación:** `apps/api/src/db/simple-verify.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `290 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/db/simple-verify.ts`
