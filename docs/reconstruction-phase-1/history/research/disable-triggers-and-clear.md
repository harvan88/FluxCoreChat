---
id: "disable-triggers-and-clear"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/disable-triggers-and-clear.ts"
...
# 🤖 disable-triggers-and-clear

**Ubicación:** `apps/api/src/scripts/disable-triggers-and-clear.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `61 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/disable-triggers-and-clear.ts`
