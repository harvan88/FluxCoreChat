---
id: "delete-account-prueba2"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/delete-account-prueba2.ts"
...
# 🤖 delete-account-prueba2

**Ubicación:** `apps/api/src/scripts/delete-account-prueba2.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `139 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/delete-account-prueba2.ts`
