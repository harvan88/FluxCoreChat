...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/describe-table.ts"
...
**Ubicación:** `apps/api/src/scripts/describe-table.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `29 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/describe-table.ts`
