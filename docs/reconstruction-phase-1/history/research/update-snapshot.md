...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/update-snapshot.ts"
...
**Ubicación:** `apps/api/src/scripts/update-snapshot.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `214 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/update-snapshot.ts`
