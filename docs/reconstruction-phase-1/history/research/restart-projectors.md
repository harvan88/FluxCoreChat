---
id: "restart-projectors"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/restart-projectors.ts"
...
**Ubicación:** `apps/api/src/scripts/restart-projectors.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `49 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/restart-projectors.ts`
