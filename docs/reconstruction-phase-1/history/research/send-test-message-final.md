---
id: "send-test-message-final"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/send-test-message-final.ts"
...
# 🤖 send-test-message-final

**Ubicación:** `apps/api/src/scripts/send-test-message-final.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `135 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/send-test-message-final.ts`
