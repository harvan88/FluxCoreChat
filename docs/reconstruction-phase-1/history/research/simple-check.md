...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/simple-check.ts"
...
**Ubicación:** `apps/api/src/scripts/simple-check.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `42 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/simple-check.ts`
