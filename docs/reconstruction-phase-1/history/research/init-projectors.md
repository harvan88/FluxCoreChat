...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/init-projectors.ts"
...
**Ubicación:** `apps/api/src/scripts/init-projectors.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `51 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/init-projectors.ts`
