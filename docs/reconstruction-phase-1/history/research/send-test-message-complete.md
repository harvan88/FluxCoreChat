---
id: "send-test-message-complete"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/send-test-message-complete.ts"
...
**Ubicación:** `apps/api/src/scripts/send-test-message-complete.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `134 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/send-test-message-complete.ts`
