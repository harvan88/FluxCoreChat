...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/last-15-minutes.ts"
...
**Ubicación:** `apps/api/src/scripts/last-15-minutes.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `43 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/last-15-minutes.ts`
