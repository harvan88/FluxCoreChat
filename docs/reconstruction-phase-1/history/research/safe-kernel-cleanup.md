---
id: "safe-kernel-cleanup"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/safe-kernel-cleanup.ts"
...
**Ubicación:** `apps/api/src/scripts/safe-kernel-cleanup.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `94 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/safe-kernel-cleanup.ts`
