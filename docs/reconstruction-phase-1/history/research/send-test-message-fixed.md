---
id: "send-test-message-fixed"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/send-test-message-fixed.ts"
...
# 🤖 send-test-message-fixed

**Ubicación:** `apps/api/src/scripts/send-test-message-fixed.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/send-test-message-fixed.ts`
