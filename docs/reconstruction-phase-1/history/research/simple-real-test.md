...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/simple-real-test.ts"
...
**Ubicación:** `apps/api/src/scripts/simple-real-test.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `277 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/simple-real-test.ts`
