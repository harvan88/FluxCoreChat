---
id: "inspect-assistants"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/inspect-assistants.ts"
...
**Ubicación:** `apps/api/src/scripts/inspect-assistants.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `23 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/inspect-assistants.ts`
