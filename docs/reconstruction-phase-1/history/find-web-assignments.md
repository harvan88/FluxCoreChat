---
id: "find-web-assignments"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/find-web-assignments.ts"
...
# 🤖 find-web-assignments

**Ubicación:** `apps/api/src/scripts/find-web-assignments.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/find-web-assignments.ts`
