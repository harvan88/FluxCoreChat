...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/cleanup-simple.ts"
...
**Ubicación:** `apps/api/src/scripts/cleanup-simple.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `76 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/cleanup-simple.ts`
