---
id: "debug-account-problem-fixed"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-account-problem-fixed.ts"
...
# 🤖 debug-account-problem-fixed

**Ubicación:** `apps/api/src/scripts/debug-account-problem-fixed.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `71 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-account-problem-fixed.ts`
