---
id: "audit-chatcore-gateway-flow"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/audit-chatcore-gateway-flow.ts"
...
# 🤖 audit-chatcore-gateway-flow

**Ubicación:** `apps/api/src/scripts/audit-chatcore-gateway-flow.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `149 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/audit-chatcore-gateway-flow.ts`
