---
id: "debug-outbox-worker-fixed"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-worker-fixed.ts"
...
# 🤖 debug-outbox-worker-fixed

**Ubicación:** `apps/api/src/scripts/debug-outbox-worker-fixed.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `95 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-outbox-worker-fixed.ts`
