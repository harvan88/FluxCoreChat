---
id: "debug-outbox-simple"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-simple.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-outbox-simple.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/debug-outbox-simple.ts`
