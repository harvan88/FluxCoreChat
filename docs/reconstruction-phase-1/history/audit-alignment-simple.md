---
id: "audit-alignment-simple"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/audit-alignment-simple.ts"
...
# 🤖 audit-alignment-simple

**Ubicación:** `apps/api/src/audit-alignment-simple.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/audit-alignment-simple.ts`
