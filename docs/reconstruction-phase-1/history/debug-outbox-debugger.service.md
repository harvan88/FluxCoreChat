---
id: "debug-outbox-debugger-service"
type: "backend-service"
status: "wip"
criticality: "medium"
location: "apps/api/src/services/debug-outbox-debugger.service.ts"
...
# 🤖 debug-outbox-debugger.service

**Ubicación:** `apps/api/src/services/debug-outbox-debugger.service.ts`
**Tipo Detectado:** `backend-service`
**Tamaño Lógico:** `144 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/services/debug-outbox-debugger.service.ts`
