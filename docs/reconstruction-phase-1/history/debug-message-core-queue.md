---
id: "debug-message-core-queue"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-message-core-queue.ts"
...
# 🤖 debug-message-core-queue

**Ubicación:** `apps/api/src/scripts/debug-message-core-queue.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `84 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-message-core-queue.ts`
