---
id: "check-problematic-account"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/check-problematic-account.ts"
...
# 🤖 check-problematic-account

**Ubicación:** `apps/api/src/check-problematic-account.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `77 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/check-problematic-account.ts`
