---
id: "check-kernel-identity"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/check-kernel-identity.ts"
...
**Ubicación:** `apps/api/src/check-kernel-identity.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `123 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/check-kernel-identity.ts`
