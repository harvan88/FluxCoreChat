---
id: "debug-outbox-linking"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-linking.ts"
...
# 🤖 debug-outbox-linking

**Ubicación:** `apps/api/src/scripts/debug-outbox-linking.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `112 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-outbox-linking.ts`
