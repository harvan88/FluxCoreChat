---
id: "audit-chatcore-simple"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/audit-chatcore-simple.ts"
...
# 🤖 audit-chatcore-simple

**Ubicación:** `apps/api/src/audit-chatcore-simple.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `280 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/audit-chatcore-simple.ts`
