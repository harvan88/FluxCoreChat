---
id: "audit-database-structure"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/audit-database-structure.ts"
...
**Ubicación:** `apps/api/src/audit-database-structure.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `241 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/audit-database-structure.ts`
