...
status: "wip"
criticality: "medium"
location: "apps/api/src/_legacy_archive/find-test-ids.ts"
...
**Ubicación:** `apps/api/src/_legacy_archive/find-test-ids.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `21 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/_legacy_archive/find-test-ids.ts`
