---
id: "cleanup-development-trash"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/cleanup-development-trash.ts"
...
# 🤖 cleanup-development-trash

**Ubicación:** `apps/api/src/scripts/cleanup-development-trash.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `143 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/cleanup-development-trash.ts`
