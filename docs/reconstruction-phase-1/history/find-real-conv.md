...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/find-real-conv.ts"
...
**Ubicación:** `apps/api/src/scripts/find-real-conv.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `14 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/find-real-conv.ts`
