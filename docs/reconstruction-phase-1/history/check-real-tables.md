---
id: "check-real-tables"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/db/check-real-tables.ts"
...
**Ubicación:** `apps/api/src/db/check-real-tables.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `73 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/db/check-real-tables.ts`
