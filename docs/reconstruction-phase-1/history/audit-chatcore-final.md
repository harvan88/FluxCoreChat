---
id: "audit-chatcore-final"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/audit-chatcore-final.ts"
...
# 🤖 audit-chatcore-final

**Ubicación:** `apps/api/src/audit-chatcore-final.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `246 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/audit-chatcore-final.ts`
