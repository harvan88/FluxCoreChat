---
id: "debug-item-payload"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-item-payload.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-item-payload.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/debug-item-payload.ts`
