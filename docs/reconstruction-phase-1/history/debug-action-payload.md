---
id: "debug-action-payload"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-action-payload.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-action-payload.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/debug-action-payload.ts`
