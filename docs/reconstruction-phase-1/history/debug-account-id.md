...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-account-id.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-account-id.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/debug-account-id.ts`
