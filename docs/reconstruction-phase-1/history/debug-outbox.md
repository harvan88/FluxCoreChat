...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-outbox.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `160 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-outbox.ts`
