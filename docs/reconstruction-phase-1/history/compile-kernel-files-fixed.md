---
id: "compile-kernel-files-fixed"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/compile-kernel-files-fixed.ts"
...
# 🤖 compile-kernel-files-fixed

**Ubicación:** `apps/api/src/scripts/compile-kernel-files-fixed.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `115 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/compile-kernel-files-fixed.ts`
