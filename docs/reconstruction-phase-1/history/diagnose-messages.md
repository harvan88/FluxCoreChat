---
id: "diagnose-messages"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/db/diagnose-messages.ts"
...
**Ubicación:** `apps/api/src/db/diagnose-messages.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/db/diagnose-messages.ts`
