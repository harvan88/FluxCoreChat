---
id: "audit-complete-flow-fixed"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/audit-complete-flow-fixed.ts"
...
# 🤖 audit-complete-flow-fixed

**Ubicación:** `apps/api/src/scripts/audit-complete-flow-fixed.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `116 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/audit-complete-flow-fixed.ts`
