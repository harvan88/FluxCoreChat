---
id: "capture-kernel-trace"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/capture-kernel-trace.ts"
...
**Ubicación:** `apps/api/src/scripts/capture-kernel-trace.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `212 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/capture-kernel-trace.ts`
