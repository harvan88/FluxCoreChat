---
id: "debug-outbox-worker-real"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-worker-real.ts"
...
# 🤖 debug-outbox-worker-real

**Ubicación:** `apps/api/src/scripts/debug-outbox-worker-real.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `93 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-outbox-worker-real.ts`
