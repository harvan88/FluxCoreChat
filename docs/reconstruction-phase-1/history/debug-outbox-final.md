---
id: "debug-outbox-final"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-final.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-outbox-final.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `99 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-outbox-final.ts`
