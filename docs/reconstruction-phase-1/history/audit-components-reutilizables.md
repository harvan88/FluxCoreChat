---
id: "audit-components-reutilizables"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/audit-components-reutilizables.ts"
...
# 🤖 audit-components-reutilizables

**Ubicación:** `apps/api/src/audit-components-reutilizables.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `275 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/audit-components-reutilizables.ts`
