---
id: "debug-kernel-ingest"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-kernel-ingest.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-kernel-ingest.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `103 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-kernel-ingest.ts`
