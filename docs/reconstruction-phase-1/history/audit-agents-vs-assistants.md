---
id: "audit-agents-vs-assistants"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/audit-agents-vs-assistants.ts"
...
# 🤖 audit-agents-vs-assistants

**Ubicación:** `apps/api/src/scripts/audit-agents-vs-assistants.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `27 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/audit-agents-vs-assistants.ts`
