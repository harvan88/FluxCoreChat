---
id: "verify-signal-creation"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/verify-signal-creation.ts"
...
**Ubicación:** `apps/api/src/scripts/verify-signal-creation.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `88 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/verify-signal-creation.ts`
