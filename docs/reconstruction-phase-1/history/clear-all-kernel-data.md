---
id: "clear-all-kernel-data"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/clear-all-kernel-data.ts"
...
# 🤖 clear-all-kernel-data

**Ubicación:** `apps/api/src/scripts/clear-all-kernel-data.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/clear-all-kernel-data.ts`
