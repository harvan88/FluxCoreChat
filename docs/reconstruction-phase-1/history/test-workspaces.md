...
status: "wip"
criticality: "medium"
location: "apps/api/src/_legacy_archive/test-workspaces.ts"
...
**Ubicación:** `apps/api/src/_legacy_archive/test-workspaces.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `297 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/_legacy_archive/test-workspaces.ts`
