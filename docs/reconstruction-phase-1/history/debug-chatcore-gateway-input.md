---
id: "debug-chatcore-gateway-input"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-chatcore-gateway-input.ts"
...
# 🤖 debug-chatcore-gateway-input

**Ubicación:** `apps/api/src/scripts/debug-chatcore-gateway-input.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `101 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-chatcore-gateway-input.ts`
