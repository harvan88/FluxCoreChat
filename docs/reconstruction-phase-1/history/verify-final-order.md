---
id: "verify-final-order"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/verify-final-order.ts"
...
**Ubicación:** `apps/api/src/scripts/verify-final-order.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/verify-final-order.ts`
