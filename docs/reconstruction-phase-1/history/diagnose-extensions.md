---
id: "diagnose-extensions"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/diagnose-extensions.ts"
...
**Ubicación:** `apps/api/src/scripts/diagnose-extensions.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `45 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/diagnose-extensions.ts`
...
- `../services/manifest-loader.service`
- `path`
- `fs`
