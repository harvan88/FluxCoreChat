---
id: "audit-complete-flow"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/audit-complete-flow.ts"
...
**Ubicación:** `apps/api/src/scripts/audit-complete-flow.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/audit-complete-flow.ts`
