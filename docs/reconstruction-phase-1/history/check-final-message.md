---
id: "check-final-message"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/check-final-message.ts"
...
**Ubicación:** `apps/api/src/check-final-message.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `105 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/check-final-message.ts`
