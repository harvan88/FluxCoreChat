...
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/verify-order-fix.ts"
...
**Ubicación:** `apps/api/src/scripts/verify-order-fix.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/verify-order-fix.ts`
