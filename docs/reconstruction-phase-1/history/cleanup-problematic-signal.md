---
id: "cleanup-problematic-signal"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/cleanup-problematic-signal.ts"
...
# 🤖 cleanup-problematic-signal

**Ubicación:** `apps/api/src/scripts/cleanup-problematic-signal.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `38 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/cleanup-problematic-signal.ts`
