---
id: "debug-signature-failure"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-signature-failure.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-signature-failure.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `206 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-signature-failure.ts`
