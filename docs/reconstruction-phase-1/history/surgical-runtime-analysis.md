---
id: "surgical-runtime-analysis"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/surgical-runtime-analysis.ts"
...
# 🤖 surgical-runtime-analysis

**Ubicación:** `apps/api/src/scripts/surgical-runtime-analysis.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `263 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/surgical-runtime-analysis.ts`
