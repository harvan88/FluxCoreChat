...
status: "wip"
criticality: "medium"
location: "apps/api/src/fix-user-account.ts"
...
**Ubicación:** `apps/api/src/fix-user-account.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `79 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/fix-user-account.ts`
