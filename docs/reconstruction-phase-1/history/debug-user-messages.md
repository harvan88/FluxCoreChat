---
id: "debug-user-messages"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-user-messages.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-user-messages.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `122 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-user-messages.ts`
