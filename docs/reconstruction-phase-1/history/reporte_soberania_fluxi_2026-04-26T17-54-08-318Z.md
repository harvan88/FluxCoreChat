...
**Fecha de Auditoría:** 26/4/2026, 14:54:08
...
- **Instrucciones IA:** ❌ FALTAN INSTRUCCIONES
- **Variables:** recurso
- **Contenido:**
```text
...
- 🔴 **CRÍTICO**: Esta plantilla no tiene instrucciones de uso. La IA no sabrá bajo qué contexto proponerla.
