---
id: "debug-account-problem"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-account-problem.ts"
...
# 🤖 debug-account-problem

**Ubicación:** `apps/api/src/scripts/debug-account-problem.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `75 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-account-problem.ts`
