---
id: "debug-outbox-source"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-outbox-source.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-outbox-source.ts`
**Tipo Detectado:** `core`
...
Ruta exacta: `apps/api/src/scripts/debug-outbox-source.ts`
