---
id: "audit-account-usage"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/audit-account-usage.ts"
...
**Ubicación:** `apps/api/src/scripts/audit-account-usage.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `92 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/audit-account-usage.ts`
