---
id: "debug-contact-click"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/debug-contact-click.ts"
...
**Ubicación:** `apps/api/src/scripts/debug-contact-click.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `83 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/debug-contact-click.ts`
