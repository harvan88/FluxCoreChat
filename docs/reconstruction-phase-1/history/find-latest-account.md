---
id: "find-latest-account"
type: "core"
status: "wip"
criticality: "medium"
location: "apps/api/src/scripts/find-latest-account.ts"
...
**Ubicación:** `apps/api/src/scripts/find-latest-account.ts`
**Tipo Detectado:** `core`
**Tamaño Lógico:** `153 líneas`


## 🎯 Propósito
Módulo, servicio o funcionalidad core del backend. (Descubierto automáticamente).
Ruta exacta: `apps/api/src/scripts/find-latest-account.ts`
