...
Frontmatter Obligatorio: Todo .md debe empezar con el YAML definido en 00-AI_DOCUMENTATION_STANDARD.md.
...
Lee mis reglas de documentación y síguelas al pie de la letra 00-AI_DOCUMENTATION_STANDARD.md