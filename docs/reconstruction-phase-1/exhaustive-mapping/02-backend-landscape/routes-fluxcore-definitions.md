---
id: "routes-fluxcore-definitions"
type: "backend-service"
status: "wip"
criticality: "medium"
location: "apps/api/src/routes/fluxcore/definitions.routes.ts"
...
# 🤖 routes-fluxcore-definitions

Servicio/Ruta de Backend auto-detectado. 
**Ubicación Real:** `apps/api/src/routes/fluxcore/definitions.routes.ts`
