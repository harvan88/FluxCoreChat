---
id: "services-fluxcore-template-semantic"
type: "backend-service"
status: "wip"
criticality: "medium"
location: "apps/api/src/services/fluxcore/template-semantic.service.ts"
...
# 🤖 services-fluxcore-template-semantic

Servicio/Ruta de Backend auto-detectado. 
**Ubicación Real:** `apps/api/src/services/fluxcore/template-semantic.service.ts`
