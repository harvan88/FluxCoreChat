---
id: "services-runtime-selection"
type: "backend-service"
status: "wip"
criticality: "medium"
location: "apps/api/src/services/runtime-selection.service.ts"
...
# 🤖 services-runtime-selection

Servicio/Ruta de Backend auto-detectado. 
**Ubicación Real:** `apps/api/src/services/runtime-selection.service.ts`
