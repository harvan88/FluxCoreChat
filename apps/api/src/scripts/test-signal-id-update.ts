...
/**
 * Probar actualizar el signal_id manualmente
 */
async function testSignalIdUpdate() {
  console.log('🔍 PROBANDO ACTUALIZACIÓN DE signal_id');
...
testSignalIdUpdate().catch(console.error);
