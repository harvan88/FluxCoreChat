...
/**
 * Probar actualizar el signal_id manualmente - versión corregida
 */
async function testSignalIdUpdateFixed() {
  console.log('🔍 PROBANDO ACTUALIZACIÓN DE signal_id - VERSIÓN CORREGIDA');
  ...
  try {
    ...
    // 2. Actualizar manualmente el signal_id
...
testSignalIdUpdateFixed().catch(console.error);
