...
/**
 * Debug del problema del accountId
 */
async function debugAccountProblem() {
  ...
  try {
    ...
    // 3. Verificar qué accountId se está usando en message-core
    console.log('\n🔍 VERIFICANDO MESSAGE-CORE:');
    console.log('Revisa el message-core.ts línea 62 para ver qué accountId se está usando');

    // 4. Mostrar todos los accounts
...
debugAccountProblem().catch(console.error);
