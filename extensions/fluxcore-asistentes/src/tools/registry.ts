...
// No more relative imports from apps/api! Using Dependency Injection instead.
        ...
        case 'search_knowledge': {
          ...
          if (!ragResult) {
            return {
              name,
              parsedArgs,
              result: { outcome: 'not_found', data: { found: false } },
              message: {
                role: 'tool',
                tool_call_id: toolCall.id,
                content: JSON.stringify({ outcome: 'not_found', data: { found: false } }),
              },
            };
          }
